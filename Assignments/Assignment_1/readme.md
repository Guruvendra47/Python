# Python Assignment 1 - Variables, Data Types, Type Casting, Keywords & Literals

**Objective:**  
Practice and master Python fundamentals: variables, built-in data types, type casting (conversion), reserved keywords, and literals.  
This assignment progresses from basic checks to small programs that require combining concepts.



## 📘 Instructions
1. Create a new Python file or notebook for each question (or group related questions).  
2. Add clear comments explaining your logic.  
3. Include sample runs (input → output) for each program.  
4. Do not use external libraries unless a question explicitly allows it.  
5. For written/theory questions, answer succinctly and accurately.
